...
namespace Dima.Api.Migrations
{
    ...
    [Migration("20260803135841_UpdateReportsModels.2")]
    partial class UpdateReportsModels2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoucherUser", b =>
                {
                    b.Property<Guid>("VoucherId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VoucherUser", b =>
                {
                    ...
                    b.HasOne("Dima.Core.Models.Voucher", null)
                        .WithMany()
                        .HasForeignKey("VoucherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
