        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedUserName = table.Column<string>(type: "VARCHAR(120)", maxLength: 120, nullable: false),
                    Email = table.Column<string>(type: "VARCHAR(160)", maxLength: 160, nullable: false),
                    NormalizedEmail = table.Column<string>(type: "VARCHAR(160)", maxLength: 160, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClaimType = table.Column<string>(type: "VARCHAR(240)", maxLength: 240, nullable: true),
                    ClaimValue = table.Column<string>(type: "VARCHAR(240)", maxLength: 240, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "VARCHAR(140)", maxLength: 140, nullable: true),
                    NormalizedName = table.Column<string>(type: "VARCHAR(140)", maxLength: 140, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUserLogin", x => new { x.LoginProvider, x.UserId, x.ProviderKey });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LoginProvider = table.Column<string>(type: "VARCHAR(180)", maxLength: 180, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUserToken", x => new { x.LoginProvider, x.UserId });
                    table.ForeignKey(
